...
const BscMainNetTokenList: Array<TokenInfo> = [
  {
    ...
    decimals: 18,
    logoURI: 'https://storageapi2.fleek.co/5bec74db-774b-4b8a-b735-f08a5ec1c1e6-bucket/tokenlist/USDT.svg',
...
const BscTestNetTokenList: Array<TokenInfo> = [
...

  {
    ...
    decimals: 18,
    logoURI: 'https://storageapi2.fleek.co/5bec74db-774b-4b8a-b735-f08a5ec1c1e6-bucket/tokenlist/UNI.svg',
...
const PolygonMainNetTokenList: Array<TokenInfo> = [
  {
    ...
    decimals: 6,
    logoURI: 'https://storageapi2.fleek.co/5bec74db-774b-4b8a-b735-f08a5ec1c1e6-bucket/tokenlist/USDT.svg', // not changed
    idOnCoingecko: "tether",
  },
  {
    name: 'ACY',
  ...
  },
  {
    ...
    decimals: 8,
    logoURI: 'https://storageapi2.fleek.co/5bec74db-774b-4b8a-b735-f08a5ec1c1e6-bucket/2021_NULS_ICON-01(1).svg',
    idOnCoingecko: "nuls",
  },
  {
    name: 'USD Coin',
